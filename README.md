...
Any `FIRE_EVENT` trigger configured with `eventName = "myEventKey"` will call your function on activation. The registry is available from the moment the mod loads.
...
Licensed under the **[MIT License](LICENSE)** — free to use, modify, and redistribute with attribution.
